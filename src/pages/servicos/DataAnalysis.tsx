        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-secondary">Áreas de Atuação</h3>
              <ul className="space-y-4">
                <li className="flex gap-3">
                  <BarChart3 className="h-6 w-6 text-primary shrink-0" />
                  <div>
                    <strong className="block text-secondary">Dashboards de BI Interativos</strong>
                ...
                <li className="flex gap-3">
                  ...
                  <div>
                    <strong className="block text-secondary">Análise Preditiva</strong>
                    <span className="text-slate-600">
                ...
                <li className="flex gap-3">
                  ...
                  <div>
                    <strong className="block text-secondary">Integração de IA Generativa</strong>
                    <span className="text-slate-600">
